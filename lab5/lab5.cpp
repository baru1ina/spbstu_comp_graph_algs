...
bool Render()
{
    ...
    //ID3D11Buffer* cbuffers2[] = { m_pSceneBuffer, m_pSphereGeomBuffer };
    //g_pd3dDeviceContext->VSSetConstantBuffers(0, 2, cbuffers2);
...
HRESULT InitScene()
{
    ...
    if (SUCCEEDED(result))
    {
        //const std::wstring TextureName = L"shiba.dds";
        const std::wstring TextureName = L"shiba.dds";
...
HRESULT InitRect()
{
    ...
    if (SUCCEEDED(result))
    {
        ...
        geomBuffer.color = Point4f{ 1.0f, 0.65f, 0.0f, 1.0f };
        ...
        if (SUCCEEDED(result))
        {
            ...
            geomBuffer.color = Point4f{ 0.0f, 0.5f, 0.0f, 1.0f };
